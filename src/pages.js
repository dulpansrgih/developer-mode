    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-800 flex flex-col gap-3">
      ...
      <div class="flex items-center justify-between gap-3 mt-4 mb-3 px-2">
        <div class="flex items-center gap-3 min-w-0">
          ...
          <div><div class="text-sm font-medium leading-tight flex items-center gap-1"><span>Dulpan AS</span>
          <svg class="w-4 h-4" viewBox="0 0 512 512"><path fill="#1DA1F2" d="M512 197.4l-73.1-42.2..."/></svg></div><div class="text-xs text-slate-500">Yogyakarta</div></div>
        </div>
    ...
    modal.innerHTML = `
      <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
        ...
        <div class="text-center">
          <div class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white py-3 rounded-xl mb-4 font-bold">Tentang Developer</div>
          <img src="assets/dulpans-url.png" class="mx-auto w-24 h-24 rounded-full border-4 border-blue-500 mb-3 shadow-lg">
          <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Dulpan Adi Saragih</h2>
          <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Web Developer & UI Enthusiast — Yogyakarta, Indonesia</p>
          <p class="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">
            KostBuYani.jogja adalah proyek digital interaktif yang dirancang untuk modernisasi sistem manajemen kost berbasis web. Dikembangkan dengan teknologi TailwindCSS, JavaScript modular, dan Firebase untuk data dinamis.
          </p>
